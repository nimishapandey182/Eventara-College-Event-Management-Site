          ...
          <nav class="hnbgu-navbar dp-sb">
            ...
            <div class="d-flex">
              ...
              <div class="hnbgu-nav-links hide-navbar pr-center" id="hnbgu-nav-links">
                ...
                <!-- <a href="#">Register</a> -->
                <a href="eventcalender">Event Calendar</a>
                ...
                ?>
                    <div href='#' class='profile-btn'>
                      ...
                      <div class="profile-drop">
                         ...
                         <a href="myevent?id=<?php echo $_SESSION['register_id'];?>" class="text-light"><i class="fa-solid fa-id-card"></i> My Events</a>
